	...
	t.Run("prefetch", func(t *testing.T) {
		...
		t.Run("publish", func(t *testing.T) {
			...
			t.Run("valid", func(t *testing.T) {
				sha, err := publishShaPrefetcher{nixPrefetchURLBin}.Prefetch("https://github.com/garethgeorge/freegoreleaser/releases/download/v1.18.2/goreleaser_Darwin_arm64.tar.gz")
				require.NoError(t, err)
